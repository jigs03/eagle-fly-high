      ...
      >
        ...
        >
          ...
          <div className="p-5 bg-orange-800 rounded-lg drop-shadow-md flex flex-col items-center justify-center w-[30%]">
            ...
            <p className="text-orange-300 text-sm drop-shadow-lg">
              Loyal Soldier in Malaysia embody true faith, allegiance to the Malaysia Constitution,
              and support leadership. Wearing the MALAYSIA Armed Forces uniform and 
              doing your part demonstrates loyalty.
            </p>
          </div>
          <div className="p-5 bg-orange-800 rounded-lg drop-shadow-md flex flex-col items-center justify-center w-[30%]">
            ...
            <p className="text-orange-300 text-sm drop-shadow-lg">
              Selfless service prioritizes the nation, Army, and subordinates,
              focusing on loyalty without recognition or gain.Each team member 
              commits to gong further, endure longer, and contribute to the effort.
            </p>
          </div>
          <div className="p-5 bg-orange-800 rounded-lg drop-shadow-md flex flex-col items-center justify-center w-[30%]">
            <h1 className="text-orange-200 text-xl drop-shadow-lg">RESPECT</h1>
            <p className="text-orange-300 text-sm drop-shadow-lg">
              The soldier's Code emphasizes treating others with dignity and respect, 
              expecting others, trusting they have fulfilled  their duties. 
              Selfrespect is crucial in the Army's Values
            </p>
          </div>
          <div className="p-5 bg-orange-800 rounded-lg drop-shadow-md flex flex-col items-center justify-center w-[30%]">
            <h1 className="text-orange-200 text-xl drop-shadow-lg">
            ...
            <p className="text-orange-300 text-sm drop-shadow-lg">
              Integrity is a moral quality developed byy adhering 
              to principles, requiring no decentful action. As integry grows,
              trust increases, impacting relationships, self-acceptance, and family and friends.
            </p>
          </div>
        </RevealList>
      </section>
